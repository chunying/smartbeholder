...
/**
 * @file
 * Smart Beholder's common functions for Windows: headers
 */

#ifndef __SB_WIN32_H__
#define __SB_WIN32_H__
...
EXPORT void sb_win32_fill_bitmap_info(BITMAPINFO *pinfo, int w, int h, int bitsPerPixel);
EXPORT long long pcdiff_us(LARGE_INTEGER t1, LARGE_INTEGER t2, LARGE_INTEGER freq);

#endif	/* USE_SB_WIN32_MACRO */
/////////////////////////////////////////////////////////////////////////
#endif	/* WIN32 */
