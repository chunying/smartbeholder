...
/**
 * @file
 * Class used to store a single Smart Beholder parameter: header files
 */

#ifndef __SB_CONFVAR_H__
#define	__SB_CONFVAR_H__

#include <map>
#include <string>

/**
 * Class used to store a single Smart Beholder parameter.
 */
class gaConfVar {
private:
