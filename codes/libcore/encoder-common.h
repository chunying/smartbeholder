...
EXPORT int encoder_register_vencoder(sb_module_t *m, void *param);
EXPORT int encoder_register_aencoder(sb_module_t *m, void *param);
EXPORT int encoder_register_sinkserver(sb_module_t *m);
EXPORT sb_module_t *encoder_get_vencoder();
EXPORT sb_module_t *encoder_get_aencoder();
EXPORT sb_module_t *encoder_get_sinkserver();
